...
if( class_exists('Ebor_Options') ){
	...
	$footer_default = 'modify this message from "appearance => customise"';
	...
	$ebor_options->add_setting('input', 'disqus_username', 'Disqus Username (enables Disqus Comments)', 'blog_layout_section', '', 15);
	$ebor_options->add_setting('select', 'blog_layout', 'Blog Archives Layout', 'blog_layout_section', 'grid-sidebar', 10, $blog_layouts);
	
	//Footer Options
	$ebor_options->add_setting('textarea', 'copyright', 'Copyright Message', 'footer_settings_section', $footer_default, 20);
