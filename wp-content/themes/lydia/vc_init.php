...
get_template_part('vc_blocks/vc_service_block');
get_template_part('vc_blocks/vc_service_image_block');
...
get_template_part('vc_blocks/vc_disqus_block');
get_template_part('vc_blocks/vc_flickr_block');
get_template_part('vc_blocks/vc_map_block');
get_template_part('vc_blocks/vc_fact_block');
...
get_template_part('vc_blocks/vc_client_block');